class EmailListsController < ApplicationController
  ...
  def new
	...
	@emailMessage_choice = EmailMessage.order("subject").collect do |c| [c.subject, c.id] end
  end
  ...
  private
    ...
    def email_list_params
      params.require(:email_list).permit(:user_id, :emailMessage_id, :viewedemail, :clickedemailad)
    end
end
